...
\end{itemize}
\begin{center}\includegraphics[width=0.35\textwidth]{img/s7_2.jpg}\end{center}
\end{frame}
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Tema 3.3: Denegación de Servicio (DoS)
  \end{itemize}
  \item Bloque 4: Pentesting:
  \begin{itemize}
    \item Tema 4.1: Hacking con metasploit
    \item Tema 4.2: Hacking Web
    \item Tema 4.5: Hacking BBDD: Inyecciones SQL
  \end{itemize}
\end{itemize}
\begin{itemize}
...
\end{itemize}
\end{itemize}
\begin{center}\includegraphics[width=0.21\textwidth]{img/s17_2.jpg}\end{center}
\end{frame}

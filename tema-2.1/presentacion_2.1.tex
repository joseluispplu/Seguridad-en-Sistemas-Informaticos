...
¿Qué es un ejercicio de red Team?
  ...
  \end{itemize}
\vfill
\begin{center}\includegraphics[width=0.80\textwidth,height=0.30\textheight,keepaspectratio]{img/sl006.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.72\textwidth,height=0.58\textheight,keepaspectratio]{img/sl014.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\vfill
\begin{center}\includegraphics[width=0.6\textwidth,height=0.4\textheight,keepaspectratio]{img/sl015.png}
\end{center}
\end{frame}
...
\small
 ...
 \end{itemize}
  \item En cualquier caso, también existen herramientas que automatizan esta labor: \href{https://github.com/trufflesecurity/trufflehog}{TruffleHog}, \href{https://github.com/gitleaks/gitleaks}{Gitleaks} (escaneo de secretos en repos) o \textbf{GitHub dorks} para localizar credenciales (\texttt{"password" org:empresa}, \texttt{filename:.env}, \texttt{extension:pem})
  \end{itemize}
\end{frame}

\begin{frame}{Ejercicio}
\small
\begin{center}\includegraphics[width=0.45\textwidth,height=0.4\textheight,keepaspectratio]{img/sl020.jpg}
\end{center}
\vspace{0.5em}
  \begin{itemize}
...
\begin{frame}{Ejercicio}
\small
\begin{center}\includegraphics[width=0.45\textwidth,height=0.4\textheight,keepaspectratio]{img/sl021.jpg}
\end{center}
\vspace{0.5em}
...
\small
  ...
  \item site:github.com "password" OR "api\_key" ext:env
  \item site:pastebin.com "smtp\_password" OR "db\_password"
  ...
  \item site:empresa.com intitle:"admin panel" OR intitle:"login"
  \item inurl:"/wp-admin/setup-config.php" site:empresa.com
        \end{itemize}

  \item Documentos internos filtrados
        \begin{itemize}

  \item site:empresa.com filetype:pdf "confidencial" OR "uso interno"
  \item site:empresa.com filetype:xls "usuario" OR "contraseña" OR "password"
...
\begin{column}{0.60\textwidth}
  \begin{itemize}
  \item Google ha lanzado una herramienta para comprobar si tú email se ha filtrado en la DarkWeb. Se entra desde \href{https://one.google.com}{one.google.com} y pulsando en el botón de "Informe sobre DarkWeb" nos dirá el sitio en el que se robó el dato.
  \end{itemize}
\end{column}
\begin{column}{0.38\textwidth}
\begin{center}\includegraphics[width=\textwidth,height=0.85\textheight,keepaspectratio]{img/sl027.jpg}
\end{center}
\end{column}
\end{columns}
\end{frame}
...
\begin{frame}{Ejercicio}
\small
\begin{center}\includegraphics[width=0.45\textwidth,height=0.4\textheight,keepaspectratio]{img/sl030.jpg}
\end{center}
\vspace{0.5em}
  \begin{itemize}
...
\begin{frame}{Ejercicio}
\small
\begin{center}\includegraphics[width=0.45\textwidth,height=0.4\textheight,keepaspectratio]{img/sl032.jpg}
\end{center}
\vspace{0.5em}
  \begin{itemize}
...
\begin{center}\includegraphics[width=\textwidth,height=0.5\textheight,keepaspectratio]{img/sl033.jpg}
\end{center}
\end{column}
\end{columns}
\end{frame}
...
\begin{center}\includegraphics[width=0.72\textwidth,height=0.58\textheight,keepaspectratio]{img/sl037.png}
\end{center}
\end{frame}
...
\footnotesize
  ...
  \end{itemize}
\vfill
\begin{center}\includegraphics[width=0.8\textwidth,height=0.32\textheight,keepaspectratio]{img/sl039.png}
\end{center}
\end{frame}
...
Búsquedas Útiles en Auditorías Reales:
  ...
  \item product:"Apache httpd" version:"2.4.49" $\leftarrow$ Path Traversal (CVE-2021-41773)
  \end{itemize}
  ...
  \item "Hikvision" country:"ES" port:80 $\leftarrow$ Cámaras Hikvision en España
  \end{itemize}

  \item Infraestructura de una organización concreta:
    \begin{itemize}

  \item org:"Telefonica" port:22 country:"ES"
  \item ssl.cert.subject.cn:"*.empresa.com" $\leftarrow$ Activos por certificado SSL
  \end{itemize}

  \item Dispositivos industriales SCADA:
    \begin{itemize}

  \item port:102 country:"ES" $\leftarrow$ Siemens S7 (PLC); presencia en OT/ICS es crítica
  \end{itemize}
...
\begin{frame}{Ejercicio}
\small
\begin{center}\includegraphics[width=0.45\textwidth,height=0.4\textheight,keepaspectratio]{img/sl041.jpg}
\end{center}
\vspace{0.5em}
  \begin{itemize}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.72\textwidth,height=0.58\textheight,keepaspectratio]{img/sl042.jpg}
\end{center}
\end{frame}
...
\begin{center}\includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{img/sl043.jpg}
\end{center}
\end{column}
\end{columns}
\end{frame}
...
\begin{center}\includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{img/sl044.jpg}
\end{center}
\end{column}
\end{columns}
\end{frame}
...
\begin{center}\includegraphics[width=\textwidth,height=0.55\textheight,keepaspectratio]{img/sl054.png}
\end{center}
\end{column}
\end{columns}
\end{frame}
...
\begin{center}\includegraphics[width=0.72\textwidth,height=0.58\textheight,keepaspectratio]{img/sl053.png}
\end{center}
\end{frame}

\begin{frame}{Ejercicio}
\small
\begin{center}\includegraphics[width=0.45\textwidth,height=0.4\textheight,keepaspectratio]{img/sl057.jpg}
\end{center}
\vspace{0.5em}
  \begin{itemize}
...
\end{column}
\begin{column}{0.43\textwidth}
\begin{center}\includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{img/sl045.png}
\end{center}
\end{column}
\end{columns}
\end{frame}
...
\begin{frame}{Ejercicio}
\small
\begin{center}\includegraphics[width=0.45\textwidth,height=0.4\textheight,keepaspectratio]{img/sl046.jpg}
\end{center}
\vspace{0.5em}
  \begin{itemize}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.72\textwidth,height=0.58\textheight,keepaspectratio]{img/sl047.jpg}
\end{center}
\end{frame}
...
SPF (Sender Policy Framework):
  ...
  \item midominio.com. IN TXT "v=spf1 mx ptr \textasciitilde{}all"
  \end{itemize}
\end{frame}
...
DKIM (Domain Keys Identified Mail):
  ...
  \item El servidor SMTP utiliza el nombre de dominio perteneciente al emisor, la cadena "\_domainkey", y un selector del campo de la firma DKIM para realizar una consulta al DNS. La respuesta debe incluir la clave pública del dominio.
  \end{itemize}
\end{frame}
...
DMARC --- Protección contra suplantación de correo:
  ...
  \end{itemize}
\vfill
\begin{center}\includegraphics[width=0.60\textwidth,height=0.24\textheight,keepaspectratio]{img/sl050.png}
\end{center}
\end{frame}


\begin{frame}{Seguridad en el correo electrónico}
\begin{center}\includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{img/sl051.png}\end{center}
\end{frame}

\begin{frame}{Seguridad en el correo electrónico}
\begin{center}\includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{img/sl052.png}\end{center}
\end{frame}
...
Estos protocolos protegen el correo, pero su \textbf{ausencia} es un vector de ataque clave:
  ...
  \item \textbf{Sin DMARC: email spoofing directo}
    \begin{itemize}
    \item El atacante envía un email como \texttt{ceo@empresa-real.com} desde su propio servidor.
    \item Si DMARC tiene política \texttt{p=none} (solo monitorización), el correo llega igualmente.
  ...
  \item \textbf{Comprobación rápida en footprinting}
    \begin{itemize}
    \item \texttt{dig TXT empresa.com} $\rightarrow$ ver registro SPF
    \item \texttt{dig TXT \_dmarc.empresa.com} $\rightarrow$ ver política DMARC
    \item Si devuelve \texttt{p=none} o no hay registro $\rightarrow$ dominio vulnerable a spoofing.
    \end{itemize}
...
\begin{center}\includegraphics[width=\textwidth,height=0.7\textheight,keepaspectratio]{img/sl058.png}
\end{center}
\end{column}
\end{columns}
\end{frame}
...
\footnotesize
  ...
  \end{itemize}
\vfill
  \begin{center}\includegraphics[width=0.85\textwidth,height=0.38\textheight,keepaspectratio]{img/sl059.png}
\end{center}
\end{frame}
...
\begin{center}\includegraphics[width=0.72\textwidth,height=0.58\textheight,keepaspectratio]{img/sl060.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\vfill
\begin{center}\includegraphics[width=0.55\textwidth,height=0.6\textheight,keepaspectratio]{img/sl062.png}
\end{center}
\end{frame}
...
\end{column}
\begin{column}{0.26\textwidth}
\begin{center}\includegraphics[width=\textwidth,height=0.55\textheight,keepaspectratio]{img/sl063.jpg}
\end{center}
\end{column}
\end{columns}
\end{frame}
...
Identificación de sistemas autónomos
  ...
  \item O directamente consultarla a los RIRs mediante WHOIS, tal y como se muestra en las siguientes consultas:
       \begin{itemize}
  \item whois -h whois.arin.net "a 701``
  \item whois -h whois.arin.net "a 701" | grep -Eo "([0--9.]+)\{4\}/[0--9]+"
...
\begin{center}\includegraphics[width=\textwidth,height=0.75\textheight,keepaspectratio]{img/sl065.png}
\end{center}
\end{column}
\end{columns}
\end{frame}
...
Identificación de rangos de red
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.72\textwidth,height=0.58\textheight,keepaspectratio]{img/sl067.png}
\end{center}
\end{frame}

\begin{frame}{Ejercicio}
\small
\begin{center}\includegraphics[width=0.45\textwidth,height=0.4\textheight,keepaspectratio]{img/sl068.jpg}
\end{center}
\vspace{0.5em}
  \begin{itemize}
...
\begin{frame}{Ejercicio}
\small
\begin{center}\includegraphics[width=0.45\textwidth,height=0.4\textheight,keepaspectratio]{img/sl077.jpg}
\end{center}
\vspace{0.5em}
  \begin{itemize}
...
Examinar el código fuente (html); puedes encontrar:
  ...
  \end{itemize}
\vfill
\begin{center}\includegraphics[width=0.8\textwidth,height=0.42\textheight,keepaspectratio]{img/sl079.png}
\end{center}
\end{frame}
...
Mensajes de error
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.72\textwidth,height=0.58\textheight,keepaspectratio]{img/sl081.png}
\end{center}
\end{frame}
...
Banner grabbing
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.72\textwidth,height=0.58\textheight,keepaspectratio]{img/sl082.png}
\end{center}
\end{frame}
...
Robots.txt
  ...
  \end{itemize}
\vfill
\begin{center}\includegraphics[width=0.62\textwidth,height=0.45\textheight,keepaspectratio]{img/sl083.jpg}
\end{center}
\end{frame}
...
\begin{frame}{Ejercicio}
\small
\begin{center}\includegraphics[width=0.45\textwidth,height=0.4\textheight,keepaspectratio]{img/sl085.jpg}
\end{center}
\vspace{0.5em}
  \begin{itemize}
...
\begin{center}\includegraphics[width=\textwidth,height=0.5\textheight,keepaspectratio]{img/sl087.jpg}
\end{center}
\end{column}
\end{columns}
\end{frame}
...
\href{https://pentest-tools.com}{PentesterTools}
  ...
  \begin{center}\includegraphics[width=0.72\textwidth,height=0.58\textheight,keepaspectratio]{img/sl086.png}
  \end{center}
\end{frame}
...
\small
 ...
 \item Fuerza bruta de subdominios: Práctica de adivinar o buscar nombres ocultos (como ://dominio.com o ://dominio.com)
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.72\textwidth,height=0.58\textheight,keepaspectratio]{img/sl091.png}
\end{center}
\end{frame}
...
\end{column}
\begin{column}{0.26\textwidth}
\begin{center}\includegraphics[width=\textwidth,height=0.55\textheight,keepaspectratio]{img/sl095.jpg}
\end{center}
\end{column}
\end{columns}
\end{frame}
...
\small
  ...
  \end{itemize}
\vfill
\begin{center}\includegraphics[width=0.62\textwidth,height=0.55\textheight,keepaspectratio]{img/sl098.png}
\end{center}
\end{frame}
...
\begin{center}\includegraphics[width=\textwidth,height=0.6\textheight,keepaspectratio]{img/sl105.png}
\end{center}
\end{column}
\end{columns}
\end{frame}
...
\begin{center}\includegraphics[width=\textwidth,height=0.6\textheight,keepaspectratio]{img/sl107.png}
\end{center}
\end{column}
\end{columns}
\end{frame}
...
\begin{frame}{OSINT}
\begin{center}\includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{img/sl106.png}\end{center}
\end{frame}

\begin{frame}{OSINT}
\begin{center}\includegraphics[width=0.55\textwidth,height=0.86\textheight,keepaspectratio]{img/sl108.jpg}\end{center}
\end{frame}
...
\begin{frame}{Ejercicio}
\small
\begin{center}\includegraphics[width=0.45\textwidth,height=0.4\textheight,keepaspectratio]{img/sl111.jpg}
\end{center}
\vspace{0.5em}
  \begin{itemize}
...
Resuelve este laboratorio de hackthebox:
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.72\textwidth,height=0.58\textheight,keepaspectratio]{img/sl113.jpg}
\end{center}
\end{frame}
...
Realiza esta room en tryhackme sobre \href{https://tryhackme.com/room/threatinteltools}{threat intelligence}
  \begin{center}\includegraphics[width=0.72\textwidth,height=0.58\textheight,keepaspectratio]{img/sl114.jpg}
\end{center}
\end{frame}

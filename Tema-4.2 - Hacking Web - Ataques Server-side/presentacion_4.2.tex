...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl068_1.jpg}
\end{center}
\end{frame}

\begin{frame}[allowframebreaks]{Ataques File Upload}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl069_1.png}
\end{center}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl069_2.png}
\end{center}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl069_3.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl070_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl071_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \item Explotar una vulnerabilidad file upload en DVWA a partir de los metadatos de un fichero:
    ...
    \end{itemize}
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl072_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \item Realiza un ataque de tipo file upload con alguna de las herramientas:
    ...
    \end{itemize}
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl073_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl076_1.jpg}
\end{center}
\end{frame}
...
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl079_1.png}
\end{center}
\end{frame}

\begin{frame}[allowframebreaks]{Realiza el ataque session ID de la aplicación DVWA}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl080_1.jpg}
\end{center}
\end{frame}
...
\begin{frame}[allowframebreaks]{Captcha Inseguros}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl083_1.png}
\end{center}
\end{frame}

\begin{frame}[allowframebreaks]{Realiza el ataque captcha de la aplicación DVWA}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl084_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl155_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \item Vulnerabilidades Web
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl157_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \item También se pueden usar los wrapper para ejecución remota de comandos (php)
    ...
    \end{itemize}
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl158_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl159_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl160_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \item Puedes probar hasta 2 tipos diferentes de inyecciones en la aplicación vulnerable Web for Pentester:
    ...
    \end{itemize}
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl161_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \item Puedes practicar el ataque Insecure Direct Object Reference en la aplicación xvwa
    ...
    \end{itemize}
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl170_1.jpg}
\end{center}
\end{frame}
...
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl175_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \item Vulnerabilidades Web
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl178_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \item Vulnerabilidades Web
  \end{itemize}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl179_1.png}
\end{center}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl179_2.png}
\end{center}
\end{frame}
...
\small
  ...
  \item Vulnerabilidades Web
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl180_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl181_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl182_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl183_1.png}
\end{center}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl183_2.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl186_1.png}
\end{center}
\end{frame}
...
\begin{frame}[allowframebreaks]{Command Injection}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl191_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl192_1.jpg}
\end{center}
\end{frame}
...
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl195_1.png}
\end{center}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl195_2.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl196_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl197_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \item ver:
    ...
    \end{itemize}
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl198_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl199_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \item Puedes hacer esta room en HackTheBox que toca los ataques. Disponible en:
    ...
    \end{itemize}
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl200_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \item Más ejemplos:
    ...
    \end{itemize}
  \end{itemize}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl208_1.png}
\end{center}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl208_2.png}
\end{center}
\end{frame}
...
\small
  ...
  \item También la puedes encontrar en:
    ...
    \end{itemize}
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl211_1.jpg}
\end{center}
\end{frame}
...
\begin{frame}[allowframebreaks]{Server Side Template Injection (SSTI)}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl218_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl219_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl226_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl227_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl228_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl229_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \item Vulnerabilidades Web
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl232_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \item Máquina Docker para prácticas SSRF:
    ...
    \end{itemize}
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl242_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl243_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \item Explota la vulnerabilidad SSRF de la aplicación vulnerable Juice Shop
    ...
    \end{itemize}
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl244_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl245_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl248_1.png}
\end{center}
\end{frame}
...
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl252_1.png}
\end{center}
\end{frame}

\begin{frame}[allowframebreaks]{Deserializar Json Web Token (JWT)}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl253_1.png}
\end{center}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl253_2.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl254_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl255_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl256_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \item Puedes resolver el lab de portswingger sobre JWT, disponible aquí:
    ...
    \end{itemize}
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl257_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl263_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl272_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \item Hacking Articles --- A Detailed Guide on Hydra
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl273_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl293_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl294_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl297_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \item Vulnerabilidades Web
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl298_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \item Vulnerabilidades Web
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl299_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \item Vulnerabilidades Web
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl300_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl301_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl302_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl342_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl343_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl344_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl345_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl346_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl378_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl379_1.jpg}
\end{center}
\end{frame}
...
% --- HackBar (movido desde 4.1: herramienta transversal) ---
\section{HackBar}

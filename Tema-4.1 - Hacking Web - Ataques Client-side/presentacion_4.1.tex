...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{img/sl010_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{img/sl015_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{img/sl017_1.png}
\end{center}
\end{frame}
...
\begin{frame}[allowframebreaks]{Introducción}
\begin{center}\includegraphics[width=0.9\textwidth,height=0.52\textheight,keepaspectratio]{img/sl019_1.png}
\end{center}
\begin{center}\includegraphics[width=0.9\textwidth,height=0.52\textheight,keepaspectratio]{img/sl019_2.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{img/sl021_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{img/sl029_1.png}
\end{center}
\end{frame}

\begin{frame}[allowframebreaks]{OWASP}
\begin{center}\includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{img/sl030_1.png}
\end{center}
\end{frame}

\begin{frame}[allowframebreaks]{OWASP}
\begin{center}\includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{img/sl031_1.jpg}
\end{center}
\end{frame}
...
\end{center}
\begin{center}\includegraphics[width=0.9\textwidth,height=0.52\textheight,keepaspectratio]{img/sl036_2.png}
\end{center}
\end{frame}
...
\small
  ...
  \item Lecturas:
    ...
    \end{itemize}
  \end{itemize}
\begin{center}\includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{img/sl039_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{img/sl052_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{img/sl053_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{img/sl054_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{img/sl055_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{img/sl056_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{img/sl057_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{img/sl058_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{img/sl059_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \item[] \cmdbox{HTML en el servidor del atacante:}
...
\small
  ...
  \item[] \cmdbox{Petición del atacante:}
  \item \cmd{Origin: https://attacker.com}
  \item[] \cmdbox{Respuesta del servidor vulnerable:}

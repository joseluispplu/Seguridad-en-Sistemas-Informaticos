...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl010_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl015_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl017_1.png}
\end{center}
\end{frame}
...
\begin{frame}[allowframebreaks]{Introducción}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl019_1.png}
\end{center}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl019_2.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl021_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl029_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \item Vulnerabilidades Web
  \end{itemize}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl036_1.png}
\end{center}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl036_2.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl046_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl048_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl050_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \item Fuente: Burp Suite for Pentester: Web Scanner \& Crawler --- Hacking Articles
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl051_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl052_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl053_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl054_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl055_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl057_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \item Repaso:
    ...
    \end{itemize}
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl062_1.jpg}
\end{center}
\end{frame}
...
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl092_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl093_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl094_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \item Lecturas:
    ...
    \end{itemize}
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl095_1.png}
\end{center}
\end{frame}

\begin{frame}[allowframebreaks]{XSS}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl096_1.png}
\end{center}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl096_2.png}
\end{center}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl096_3.png}
\end{center}
\end{frame}

\begin{frame}[allowframebreaks]{Haz un ataque de tipo defacement a partir de un XSS en DVWA}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl097_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl098_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \item Puedes probar hasta 9 tipos diferentes de inyecciones en la aplicación vulnerable Web for Pentester:
    ...
    \end{itemize}
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl099_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \item XSS
  \end{itemize}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl100_1.png}
\end{center}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl100_2.png}
\end{center}
\end{frame}
...
\small
  ...
  \item XSS
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl101_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \item Realiza un ataque de tipo DOM based XSS en la aplicación DVWA (docker)
    ...
    \end{itemize}
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl102_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \item XSS
  \end{itemize}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl103_1.png}
\end{center}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl103_2.png}
\end{center}
\end{frame}
...
\small
  ...
  \item XSS
  \end{itemize}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl104_1.png}
\end{center}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl104_2.png}
\end{center}
\end{frame}
...
\small
  ...
  \item XSS
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl105_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl106_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \item XSS
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl107_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \item XSS
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl108_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \item XSS
  \end{itemize}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl109_1.png}
\end{center}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl109_2.png}
\end{center}
\end{frame}

\begin{frame}[allowframebreaks]{Realiza un ataque de tipo watering hole con un XSS}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl110_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \item XSS
  \end{itemize}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl111_1.png}
\end{center}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl111_2.png}
\end{center}
\end{frame}
...
\small
  ...
  \item XSS
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl112_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \item XSS
  \end{itemize}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl113_1.png}
\end{center}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl113_2.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl114_1.jpg}
\end{center}
\end{frame}

\begin{frame}[allowframebreaks]{Sessión Hijacking con XSS}
\small
  \begin{itemize}
  ...
  \item XSS
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl115_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \item XSS
  \end{itemize}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl116_1.png}
\end{center}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl116_2.png}
\end{center}
\end{frame}
...
\small
  ...
  \item XSS
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl117_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \item XSS
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl118_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl119_1.jpg}
\end{center}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl119_2.png}
\end{center}
\end{frame}
...
\small
  ...
  \item XSS
  \end{itemize}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl120_1.png}
\end{center}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl120_2.png}
\end{center}
\end{frame}
...
\small
  ...
  \item XSS
  \end{itemize}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl121_1.png}
\end{center}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl121_2.png}
\end{center}
\end{frame}
...
\small
  ...
  \item XSS
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl122_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl123_1.jpg}
\end{center}
\end{frame}
...
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl125_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \item XSS
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl126_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \item XSS
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl127_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \item XSS
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl128_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \item XSS
  \end{itemize}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl129_1.png}
\end{center}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl129_2.png}
\end{center}
\end{frame}
...
\small
  ...
  \item XSS
  \end{itemize}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl130_1.png}
\end{center}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl130_2.png}
\end{center}
\end{frame}
...
\small
  ...
  \item XSS
  \end{itemize}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl132_1.png}
\end{center}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl132_2.png}
\end{center}
\end{frame}
...
\begin{frame}[allowframebreaks]{CSRF}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl135_1.png}
\end{center}
\end{frame}

\begin{frame}[allowframebreaks]{Realiza un ataque CSRF en la web DVWA}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl136_1.jpg}
\end{center}
\end{frame}

\begin{frame}[allowframebreaks]{Realiza un ataque XSS almacenado con un CSRF en DVWA}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl137_1.jpg}
\end{center}
\end{frame}
...
\small
  ...
  \item CSRF e Ingeniería Social:
    ...
    \end{itemize}
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl138_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \item CSRF e Ingeniería Social:
    ...
    \end{itemize}
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl139_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \item CSRF e Ingeniería Social:
    ...
    \end{itemize}
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl140_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \item Vulnerabilidades Web
  \end{itemize}
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl141_1.png}
\end{center}
\end{frame}
...
\small
  ...
  \item Soluciones
  \end{itemize}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl142_1.jpg}
\end{center}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl142_2.png}
\end{center}
\begin{center}\includegraphics[width=0.6\textwidth,height=0.42\textheight,keepaspectratio]{img/sl142_3.png}
\end{center}
\end{frame}
...
\begin{center}\includegraphics[width=0.78\textwidth,height=0.6\textheight,keepaspectratio]{img/sl149_1.jpg}
\end{center}
\end{frame}
